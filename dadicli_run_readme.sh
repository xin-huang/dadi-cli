...
#
time dadi-cli GenerateCache --model split_mig --single-gamma \
--demo-popt ./examples/results/demo/1KG.YRI.CEU.20.split_mig.demo.params.InferDM.bestfits \
--misid --sample-size 20 20 --grids 60 70 80 --gamma-pts 10 --gamma-bounds 1e-4 200 \
...
#
time dadi-cli GenerateCache --model split_mig \
--demo-popt ./examples/results/demo/1KG.YRI.CEU.20.split_mig.demo.params.InferDM.bestfits \
--misid --sample-size 20 20 --grids 60 70 80 --gamma-pts 10 --gamma-bounds 1e-4 200 \
...
echo Godambe
#
time dadi-cli Stat --fs ./examples/results/fs/1KG.YRI.CEU.20.synonymous.snps.unfold.fs \
...
time dadi-cli Stat --fs ./examples/results/fs/1KG.YRI.CEU.20.nonsynonymous.snps.unfold.fs \
