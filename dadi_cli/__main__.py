...
def dadi_cli_parser():
    ...
    parser.add_argument('--mask-singleton', default=False, action='store_true', dest='mask', help='Mask the singletons that are exclusive to each population. Default: None')
    parser.add_argument('--mask-singleton-shared', default=False, action='store_true', dest='mask_shared', help='Mask the singletons that are exclusive to each population and shared between populations. Default: None')
