...
def add_demo_popt_argument(parser):
    parser.add_argument('--demo-popt', type=str, required=True, help='File containing the bestfit parameters for the demographic model.', dest='demo_popt')
...
def add_popt_argument(parser):
    parser.add_argument('--demo-popt', type=str, dest='demo_popt', help='File containing the bestfit demographic parameters, generated by `dadi-cli BestFit`.')
    parser.add_argument('--dfe-popt', type=str, dest='dfe_popt', help='File containing the bestfit DFE parameters, generated by `dadi-cli BestFit`.')
