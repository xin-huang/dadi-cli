...
def infer_dfe(fs, cache1d, cache2d, sele_dist, sele_dist2, theta,
    ...
    if cache1d != None: func = cache1d.integrate
    if cache2d != None: func = cache2d.integrate
   
    if sele_dist != None: sele_dist = get_dadi_pdf(sele_dist)
    if sele_dist2 != None: sele_dist2 = get_dadi_pdf(sele_dist2)
    if (sele_dist == None) and (sele_dist2 != None): sele_dist = sele_dist2
