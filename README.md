...
Here we want to test whether the DFE correlation (the fourth parameter) is different from zero. We use `--pi` to specify which parameter is tested. `--lrt` is used for performing likelihood ratio test.
