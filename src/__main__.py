def main():
    ...
    plot_parser.add_argument('--dfe-popt', type=str, help='The file containing the bestfit parameters for the distribution of fitness effects, generated by `dadi-cli Bestfit`', dest='sel_popt')
    ...
    plot_parser.add_argument('--demo-model', type=str, help='The name of the demographic model; To check available demographic models, please use `dadi-cli Model`')
    ...
    stat_parser.add_argument('--demo-model', type=str, help='The name of the demographic model; To check available demographic models, please use `dadi-cli Model`')
