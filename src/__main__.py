def main():
    ...
    stat_parser.add_argument('--popt', type=str, required=True, help='The file containing the bestfit parameters for the complex model, generated by `dadi-cli Bestfit`')
    ...
    if args.subcommand == 'GenerateFs':
        ...
        godambe_stat(fs=args.fs, model=args.model, bootstrap_dir=args.bootstrapping_dir, 
                     ...
                     sele_dist2=args.pdf2d, popt=args.popt, misid=args.misid, demo_popt=args.demo_popt,
