def main():
    ...
    stat_parser.add_argument('--bootstrapping-dir', type=str, required=True, help='The Directory containing boostrapping spectra', dest='bootstrap_dir')
    stat_parser.add_argument('--pdf', type=str, help='The 1D probability density function for the DFE inference; To check available probability density functions, please use `dadi-cli Pdf`')
    stat_parser.add_argument('--pdf2', type=str, help='The 2D probability density function for the joint DFE inference; To check available probability density functions, please use `dadi-cli Pdf')
