...
generate_cache_parser.add_argument('--demo-popt', type=str, help='The file containing the bestfit parameters for the demographic model, generated by `dadi-CLI Bestfit`', dest='demo_popt')
...
infer_dfe_parser.add_argument('--ratio', type=float, required=True, help='The ratio for the nonsynonymous mutations vs. the synonymous mutations')
